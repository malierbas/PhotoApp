...
class BackgroundSelectionViewController: UIViewController {
    ...
    var backgrounds: [Background] = [
        Background(image: UIImage(named: "marble1"), preview: UIImage(named: "marble1-preview"), isFree: true, type: .pattern),
        Background(image: UIImage(named: "marble2"), preview: UIImage(named: "marble2-preview"), isFree: true, type: .pattern),
        Background(image: UIImage(named: "marble3"), preview: UIImage(named: "marble3-preview"), type: .pattern),
        Background(image: UIImage(named: "bg-wood-dark"), preview: UIImage(named: "bg-wood-dark-preview"), isFree: true, type: .pattern),
        Background(image: UIImage(named: "bg-wood"), preview: UIImage(named: "bg-wood-preview"), isFree: true, type: .pattern),
        ...
        Background(image: UIImage(named: "rainDrop"), preview: UIImage(named: "rainDrop-preview"), isFree: true, type: .pattern),
        ...
        Background(image: UIImage(named: "flowersWall"), preview: UIImage(named: "flowersWall-preview"), isFree: true, type: .pattern),
        ...
        Background(isFree: true, type: .gradient, gradientLayerView: GradientLayerView(colors: [UIColor(hexString: "#FF416C"), UIColor(hexString: "#FF4B2B")])),
        Background(isFree: true, type: .gradient, gradientLayerView: GradientLayerView(colors: [UIColor(hexString: "#8A2387"), UIColor(hexString: "#E94057"), UIColor(hexString: "#F27121")])),
        Background(isFree: true, type: .gradient, gradientLayerView: GradientLayerView(colors: [UIColor(hexString: "#a8ff78"), UIColor(hexString: "#78ffd6")])),
        Background(isFree: true, type: .gradient, gradientLayerView: GradientLayerView(colors: [UIColor(hexString: "#ED213A"), UIColor(hexString: "#93291E")])),
        Background(isFree: true, type: .gradient, gradientLayerView: GradientLayerView(colors: [UIColor(hexString: "#FDC830"), UIColor(hexString: "#F37335")])),
        Background(isFree: true, type: .gradient, gradientLayerView: GradientLayerView(colors: [UIColor(hexString: "#00B4DB"), UIColor(hexString: "#0083B0")])),
        Background(isFree: true, type: .gradient, gradientLayerView: GradientLayerView(colors: [UIColor(hexString: "#a17fe0"), UIColor(hexString: "#5D26C1")])),
        Background(isFree: true, type: .gradient, gradientLayerView: GradientLayerView(colors: [UIColor(hexString: "#FFFDE4"), UIColor(hexString: "#005AA7")])),
        Background(isFree: true, type: .gradient, gradientLayerView: GradientLayerView(colors: [UIColor(hexString: "#DA4453"), UIColor(hexString: "#89216B")])),
        Background(isFree: true, type: .gradient, gradientLayerView: GradientLayerView(colors: [UIColor(hexString: "#ad5389"), UIColor(hexString: "#3c1053")])),
        Background(isFree: true, type: .gradient, gradientLayerView: GradientLayerView(colors: [UIColor(hexString: "#a8c0ff"), UIColor(hexString: "#3f2b96")])),
        Background(isFree: true, type: .gradient, gradientLayerView: GradientLayerView(colors: [UIColor(hexString: "#4e54c8"), UIColor(hexString: "#8f94fb")])),
        Background(isFree: true, type: .gradient, gradientLayerView: GradientLayerView(colors: [UIColor(hexString: "#bc4e9c"), UIColor(hexString: "#f80759")])),
        Background(isFree: true, type: .gradient, gradientLayerView: GradientLayerView(colors: [UIColor(hexString: "#11998e"), UIColor(hexString: "#38ef7d")])),
        Background(isFree: true, type: .gradient, gradientLayerView: GradientLayerView(colors: [UIColor(hexString: "#FC5C7D"), UIColor(hexString: "#6A82FB")])),
        Background(isFree: true, type: .gradient, gradientLayerView: GradientLayerView(colors: [UIColor(hexString: "#FC466B"), UIColor(hexString: "#3F5EFB")])),
        Background(isFree: true, type: .gradient, gradientLayerView: GradientLayerView(colors: [UIColor(hexString: "#00b09b"), UIColor(hexString: "#96c93d")])),
        Background(isFree: true, type: .gradient, gradientLayerView: GradientLayerView(colors: [UIColor(hexString: "#00F260"), UIColor(hexString: "#0575E6")])),
        Background(isFree: true, type: .gradient, gradientLayerView: GradientLayerView(colors: [UIColor(hexString: "#74ebd5"), UIColor(hexString: "#ACB6E5")])),
        Background(isFree: true, type: .gradient, gradientLayerView: GradientLayerView(colors: [UIColor(hexString: "#667db6"), UIColor(hexString: "#0082c8"), UIColor(hexString: "#0082c8"), UIColor(hexString: "#667db6")])),
        Background(isFree: true, type: .gradient, gradientLayerView: GradientLayerView(colors: [UIColor(hexString: "#e1eec3"), UIColor(hexString: "#f05053")])),
        Background(isFree: true, type: .gradient, gradientLayerView: GradientLayerView(colors: [UIColor(hexString: "#ff9966"), UIColor(hexString: "#ff5e62")])),
        Background(isFree: true, type: .gradient, gradientLayerView: GradientLayerView(colors: [UIColor(hexString: "#d9a7c7"), UIColor(hexString: "#fffcdc")])),
        Background(isFree: true, type: .gradient, gradientLayerView: GradientLayerView(colors: [UIColor(hexString: "#0cebeb"), UIColor(hexString: "#20e3b2"), UIColor(hexString: "#29ffc6")])),
        Background(isFree: true, type: .gradient, gradientLayerView: GradientLayerView(colors: [UIColor(hexString: "#06beb6"), UIColor(hexString: "#48b1bf")])),
        Background(isFree: true, type: .gradient, gradientLayerView: GradientLayerView(colors: [UIColor(hexString: "#642B73"), UIColor(hexString: "#C6426E")])),
        Background(isFree: true, type: .gradient, gradientLayerView: GradientLayerView(colors: [UIColor(hexString: "#1c92d2"), UIColor(hexString: "#f2fcfe")])),
        Background(isFree: true, type: .gradient, gradientLayerView: GradientLayerView(colors: [UIColor(hexString: "#36D1DC"), UIColor(hexString: "#5B86E5")])),
        Background(isFree: true, type: .gradient, gradientLayerView: GradientLayerView(colors: [UIColor(hexString: "#159957"), UIColor(hexString: "#155799")])),
        Background(isFree: true, type: .gradient, gradientLayerView: GradientLayerView(colors: [UIColor(hexString: "#1CB5E0"), UIColor(hexString: "#000046")])),
        Background(isFree: true, type: .gradient, gradientLayerView: GradientLayerView(colors: [UIColor(hexString: "#007991"), UIColor(hexString: "#78ffd6")])),
        Background(isFree: true, type: .gradient, gradientLayerView: GradientLayerView(colors: [UIColor(hexString: "#56CCF2"), UIColor(hexString: "#2F80ED")])),
        Background(isFree: true, type: .gradient, gradientLayerView: GradientLayerView(colors: [UIColor(hexString: "#EB5757"), UIColor(hexString: "#000000")])),
        Background(isFree: true, type: .gradient, gradientLayerView: GradientLayerView(colors: [UIColor(hexString: "#4AC29A"), UIColor(hexString: "#BDFFF3")])),
        Background(isFree: true, type: .gradient, gradientLayerView: GradientLayerView(colors: [UIColor(hexString: "#B2FEFA"), UIColor(hexString: "#0ED2F7")]))
    ]
