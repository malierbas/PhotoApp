...
class StickerSelectionViewController: UIViewController {
    ...
    var stickers = [
        Sticker(image:UIImage(named: "new-stickers-3"), isFree: false),
        Sticker(image:UIImage(named: "new-stickers-1"), isFree: false),
        Sticker(image:UIImage(named: "new-stickers-4"), isFree: false),
        Sticker(image:UIImage(named: "new-stickers-6"), isFree: false),
        Sticker(image:UIImage(named: "new-stickers-8")),
        Sticker(image:UIImage(named: "new-stickers-7"), isFree: false),
        Sticker(image:UIImage(named: "new-stickers-10"), isFree: false),
        Sticker(image:UIImage(named: "new-stickers-2")),
        Sticker(image:UIImage(named: "new-stickers-9")),
        Sticker(image:UIImage(named: "pink_hand_painted_love_2")),
        Sticker(image:UIImage(named: "pink_hand_painted_love"), isFree: false),
        Sticker(image:UIImage(named: "group1")),
        Sticker(image:UIImage(named: "paper clip1")),
        Sticker(image:UIImage(named: "paper clip2")),
        Sticker(image:UIImage(named: "pintle")),
        Sticker(image:UIImage(named: "band1")),
        Sticker(image:UIImage(named: "band2")),
        Sticker(image:UIImage(named: "band3")),
        Sticker(image:UIImage(named: "band4")),
        Sticker(image:UIImage(named: "band5")),
        Sticker(image:UIImage(named: "band6")),
        Sticker(image:UIImage(named: "band7")),
        Sticker(image:UIImage(named: "band8")),
        Sticker(image:UIImage(named: "band9")),
        Sticker(image:UIImage(named: "band10")),
        Sticker(image:UIImage(named: "band11")),
        Sticker(image:UIImage(named: "gold1")),
        Sticker(image:UIImage(named: "gold2")),
        Sticker(image:UIImage(named: "gold3")),
        Sticker(image:UIImage(named: "gold4")),
        Sticker(image:UIImage(named: "gold5")),
        Sticker(image:UIImage(named: "gold6")),
        Sticker(image:UIImage(named: "gold7"), isFree: false),
        Sticker(image:UIImage(named: "gold8")),
        Sticker(image:UIImage(named: "gold9"))
    ]
