...
public class ZLPhotoConfiguration: NSObject {
    ...
    private var pri_editImageTools: [ZLEditImageViewController.EditImageTool] = [.draw, .clip, .imageSticker, .textSticker, .mosaic, .filter, .removeBackground]
    ...
    public var editImageTools: [ZLEditImageViewController.EditImageTool] {
        ...
        get {
            if pri_editImageTools.isEmpty {
                return [.draw, .clip, .imageSticker, .textSticker, .mosaic, .filter, .removeBackground]
            } else {
